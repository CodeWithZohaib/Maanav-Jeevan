      ...
      <div className="container-custom flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button variant="warm" size="sm" className="shadow-md" asChild>
        ...
        {isMobileOpen && (
          ...
          >
            <div className="container-custom py-6 flex flex-col gap-4">
                ...
                link.isHash ? (
                  ...
                  >
                    <Link
                      to={link.href}
                      onClick={() => setIsMobileOpen(false)}
                      className="text-muted-foreground hover:text-foreground transition-colors duration-300 text-base font-medium py-2 block"
                    >
                      {link.name}
                    </Link>
                  </motion.div>
              ...
              >
                <Button variant="warm" className="mt-2 w-full shadow-md" asChild>
                  <Link to="/donate" onClick={() => setIsMobileOpen(false)}>Donate Now</Link>
                </Button>
              </motion.div>
            </div>
          </motion.div>
